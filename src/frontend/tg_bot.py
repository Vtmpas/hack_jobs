...
async def reply_on_dislike(callback: types.CallbackQuery):
    await bot.send_message(callback.from_user.id, '🙁 Мы заметили, что вам не понравилась предыдущая рекомендация. Нам очень жаль, что она не соответствовала вашим ожиданиям. Мы постоянно работаем над улучшением нашего сервиса, и ваша обратная связь крайне важна для нас.

🔍 Мы были бы благодарны, если бы вы могли поделиться дополнительными комментариями о том, что именно вам не понравилось или что мы могли бы улучшить. Это поможет нам сделать наш сервис лучше.

🔄 Пожалуйста, попробуйте использовать наш сервис снова с другой вакансией. Мы уверены, что сможем предложить более подходящие курсы, которые помогут вам в достижении профессиональных целей.
