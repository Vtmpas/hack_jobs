    ...
    if msg.document is not None:
        ...
        if not hh_link_filter(url):
            ...
            try:
                ...
                await bot.send_message(msg.from_user.id, '''🙁 Мы заметили, что вам не понравилась предыдущая рекомендация. Нам очень жаль, что она не соответствовала вашим ожиданиям. Мы постоянно работаем над улучшением нашего сервиса, и ваша обратная связь крайне важна для нас.
